...
function initMap() {
    ...
    // Agregar un marcador personalizado con animación BOUNCE
    const image =
        "./img/venado.png";  //CREAMOS LA CONSTANTE CON LA RUTA DE LA IMAGEN
    ...
    if (navigator.geolocation) {
      ...
      () => {
        console.log("Error obteniendo la ubicación actual.");
      }
    );
  }
}
